---
title: "Assignment1" test2
output: html_document
---
# 3.3.1 #2 #4 #6
#3.5.1 #4
# go back and understand graphs for 3.6.1 #6
# 3.7.1 #2
...
## Question 2  *******************
## Categorical variables: manufacturer, model, displ, cyl, trans, drv, fl, class
## continuous variables: year, cty, hwy, 
```{r}
mpg
?mpg
```
...
# https://www.patrickjomalley.com/2017/10/data-visualization/
...
# Question 3****************** what do i need to install to make the code for this work
